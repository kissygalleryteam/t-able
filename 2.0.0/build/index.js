...
kg/t-able/2.0.0/src/datastore
kg/t-able/2.0.0/src/dproxy
kg/t-able/2.0.0/src/column
kg/t-able/2.0.0/src/header
kg/t-able/2.0.0/src/footer
kg/t-able/2.0.0/src/index
kg/t-able/2.0.0/src/pagination
kg/t-able/2.0.0/index

*/
KISSY.add('kg/t-able/2.0.0/src/datastore',function(S, Event) {
 ...
 *
 */
KISSY.add('kg/t-able/2.0.0/src/dproxy',function(S, Node) {
    var $ = Node.all;
 ...
 * Column
 */
KISSY.add('kg/t-able/2.0.0/src/column',function(S, Node, Event, XTemplate, DProxy) {
    var $ = Node.all,
        def = {},
...
KISSY.add('kg/t-able/2.0.0/src/header',function(S, Node, Event, XTemplate, DProxy) {
    var $ = Node.all,
        def = {
            template: '<tr>' +
                '{{@each columns}}' +
...
KISSY.add('kg/t-able/2.0.0/src/footer',function(S, Node, Event, XTemplate, DProxy) {
    var $ = Node.all,
        def = {
            template: ""
        };
 ...
 *
 */
KISSY.add('kg/t-able/2.0.0/src/index',function(S, Node, Event, XTemplate, Store, Column, Header, Footer) {
    var $ = Node.all,
        idAttribute = '_uid',
        def = {
 ...
 */
KISSY.add('kg/t-able/2.0.0/src/pagination',function(S, Node, XTemplate) {
 ...
 * @module t-able
 **/
KISSY.add('kg/t-able/2.0.0/index',function (S, Table, Store, Column, Header, Footer, Pagination) {
